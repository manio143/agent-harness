            ...
            async IAsyncEnumerable<MeaiChatResponseUpdate> MainHi_Tools_CreateChild()
            {
                ...
                yield return new MeaiChatResponseUpdate
                {
                    Contents = new List<MeaiAIContent>
                    {
                        ...
                        new MeaiFunctionCallContent("call_mhi_1", "thread_start", new Dictionary<string, object?> { ["name"] = "child", ["context"] = "fork", ["mode"] = "multi", ["message"] = "do work", ["delivery"] = "immediate" }),
                    }
                };
