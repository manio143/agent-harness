        ...
        private async IAsyncEnumerable<MeaiChatResponseUpdate> Main_SpawnChild()
        {
            yield return new MeaiChatResponseUpdate
            {
                Contents = new List<MeaiAIContent>
                {
                    ...
                    new MeaiFunctionCallContent("call_m1", "thread_start", new Dictionary<string, object?> { ["name"] = "child", ["context"] = "fork", ["mode"] = "multi", ["message"] = "Initial message: child should call mcp_echo", ["delivery"] = "immediate" }),
                }
            };
